                ...
                */
                ...
                if (text.toLowerCase().startsWith('.cumplimiento')) {
                    ...
                    try {
                        ...
                        Tu objetivo principal es recomendar hardware profesional que se pueda comprar fácilmente con distribuidores mayoristas. Dale alta prioridad a marcas líderes del mercado como: Huawei, Mikrotik, Ubiquiti, Cisco, Aruba, Fortinet, Ruckus, Cambium, Grandstream, TP-Link, Epcom, Hikvision, Dahua, Linkedpro, Axis, Hanwha, Bosch, Honeywell, ZKTeco, Panduit, Belden, APC, Tripp Lite y otras marcas reconocidas globalmente. Aunque el catálogo de Syscom es una referencia importante, no te limites solo a él; incluye cualquier marca de renombre con presencia sólida en el mercado. Evita marcas genéricas o sin soporte.
