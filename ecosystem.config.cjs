  ...
  apps: [
    {
      ...
      env: {
        ...
        BOT_STALE_SOCKET_MS: '900000',
        BOT_SUSPEND_DETECTION_MS: '60000',
        BOT_SUSPEND_CHECK_INTERVAL_MS: '5000',
        BOT_PRESENCE_KEEPALIVE_MS: '300000',
        BOT_KEEPALIVE_ACTIVITY_GRACE_MS: '120000',
        BOT_WATCHDOG_MAX_RECONNECTS_PER_WINDOW: '3',
        BOT_WATCHDOG_COOLDOWN_MS: '7200000',
        BOT_PROACTIVE_POST_RECONNECT_COOLDOWN_MS: '120000',
        ...
        PROACTIVE_SHOWCASE_INTERVAL_MS: '86400000',
        PROACTIVE_SHOWCASE_PROMPT_GAP_MS: '14400000',
